...
namespace eval ::optrace {
  variable script "E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0.tcl"
...
set cached_ip [config_ip_cache -export -no_bom  -dir E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force E:/hdmi_fpga/hdmi/hdmi.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir E:/hdmi_fpga/hdmi/hdmi.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v E:/hdmi_fpga/hdmi/hdmi.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir E:/hdmi_fpga/hdmi/hdmi.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force e:/hdmi_fpga/hdmi/hdmi.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl E:/hdmi_fpga/hdmi/hdmi.ip_user_files/ip/clk_wiz_0
  }
}
